...
public class Hangman {
	...
	static String[] nizRjeci = { "heap", "array", "double", "short", "math",
			"main", "this", "public","program","Inheritance", "polymorphism", "void","class" };
	...
	// ova metoda sluzi za brpojanje promasenih slova(vraca 1), ali ujedno i
	...
	public static int odgovor(char c) {
		...
		System.out.println("Slovo \"" + c
				+ "\" se ne nalazi ispod ?, idete na vjesala!");
		return 1;
